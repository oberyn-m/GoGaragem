<div class="app-sidebar colored">
    <div style="background-color: #fff;" class="sidebar-header">
        <a data-toggle="tooltip" data-placement="bottom" title="Home" class="header-brand" href="<?php echo base_url('/'); ?>">
            <div class="logo-img">
                <img style="width: 100px;" src="<?php echo base_url('public/src/img/garage-logo.png'); ?>" class="header-brand-img" alt="Logo Go Garagem"> 
            </div>
        </a>
        ...
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item <?php echo ($this->router->fetch_class() == 'estacionar' && $this->router->fetch_method() == 'index' ? 'active' : ''); ?>">
                    <a data-toggle="tooltip" data-placement="bottom" title="Estacionar" href="<?php echo base_url('/estacionar') ?>"><i class="fas fa-warehouse"></i><span>Estacionar</span></a>
                </div>
