                    ...
                    <div class="modal-body d-flex align-items-center">
                        <div class="container">
                            <div class="apps-wrap">
                                ...
                                <div class="app-item">
                                    <a href="<?php echo base_url('estacionar'); ?>"><i class="fas fa-warehouse"></i><span>Estacionar</span></a>
                                </div>
                                <div class="app-item">
                                ...
                                <div class="app-item">
                                    <a href="<?php echo base_url('usuarios'); ?>"><i class="fas fa-users"></i><span>Usuários</span></a>
                                </div>
                                <div class="app-item">
