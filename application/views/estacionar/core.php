    ...
    <div class="main-content">		
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header"><?php echo(isset($estacionado) ? '<i class="ik ik-calendar ik-2x"></i>&nbspData da última alteração:&nbsp' . formata_data_banco_com_hora($estacionado->estacionar_data_alteracao) : ''); ?></div>
                        <div class="card-body">
