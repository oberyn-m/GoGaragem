    ...
    <div class="main-content">		
        <div class="container-fluid">
                    ...
                    <div class="col-lg-4">
                        <nav class="breadcrumb-container" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a data-toggle="tooltip" data-placement="bottom" title="Listar <?php echo $this->router->fetch_class(); ?>" href="<?php echo base_url('/formas'); ?>">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header"><?php echo(isset($forma) ? '<i class="ik ik-calendar ik-2x"></i>&nbspData da última alteração:&nbsp' . formata_data_banco_com_hora($forma->forma_pagamento_data_alteracao) : ''); ?></div>
                        <div class="card-body">
