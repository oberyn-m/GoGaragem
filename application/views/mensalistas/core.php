    ...
    <div class="main-content">		
        <div class="container-fluid">
                    ...
                    <div class="col-lg-4">
                        <nav class="breadcrumb-container" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a data-toggle="tooltip" data-placement="bottom" title="Listar <?php echo $this->router->fetch_class(); ?>" href="<?php echo base_url('/mensalistas'); ?>">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header"><?php echo(isset($mensalista) ? '<i class="ik ik-calendar ik-2x"></i>&nbspData da última alteração:&nbsp' . formata_data_banco_com_hora($mensalista->mensalista_data_alteracao) : ''); ?></div>
                        <div class="card-body">
                            <form class="forms-sample" name="form_core" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2 mb-20">
                                        <label>Número</label>
                                        <input type="text" class="form-control cep" name="mensalista_numero_endereco" value="<?php echo (isset($mensalista) ? $mensalista->mensalista_numero_endereco : set_value('mensalista_numero_endereco')); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 mb-20">
                                        ...
                                        <!-- 
                                            <textarea rows="1" class="form-control" name="mensalista_observacao" value="<?php echo (isset($mensalista) ? $mensalista->mensalista_observacao : set_value('mensalista_observacao')); ?>"></textarea>
                                        -->
                                        <input type="text" class="form-control" name="mensalista_observacao" value="<?php echo (isset($mensalista) ? $mensalista->mensalista_observacao : set_value('mensalista_observacao')); ?>">
